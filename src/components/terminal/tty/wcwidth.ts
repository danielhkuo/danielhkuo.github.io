/**
 * Display width of a code point in terminal cells, after Markus Kuhn's
 * `wcwidth`: 2 for East Asian wide and fullwidth forms and for emoji with
 * default emoji presentation, 1 for everything else. Combining marks would be
 * 0 in libc, but cbonsai divides by the width, so they count as 1 here.
 */
const WIDE: ReadonlyArray<readonly [number, number]> = [
  ...
  [0x17000, 0x18aff], [0x1b000, 0x1b2ff], [0x1f004, 0x1f004],
  [0x1f0cf, 0x1f0cf], [0x1f18e, 0x1f18e], [0x1f191, 0x1f19a],
  [0x1f200, 0x1f251], [0x1f300, 0x1f320], [0x1f32d, 0x1f335],
...
export function wcwidth(cp: number): 1 | 2 {
